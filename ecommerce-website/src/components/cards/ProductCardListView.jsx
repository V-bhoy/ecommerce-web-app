...
export default function ProductCardListView(){
    return <div className={"productCard rounded-md bg-orange-50 flex gap-3"}>
        ...
        <div className={"info px-2 py-6 flex flex-col gap-1"}>
            ...
            <p className={"text-[12px] text-primary font-[500]"}>Silk kurta set in teal with ombre georgette dupatta.</p>
            <p className={"text-[11px] text-gray-500"}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
